...
namespace SpaceBattle.Lib.Tests
{
    public class LongOperationTests
    {
        ...
        public void LongOperationTestPositive()
        {
            ...
            IoC.Resolve<Hwdtech.ICommand>("IoC.Register", "Commands.Injectable", (object[] args) => injectCommand).Execute();
        ...
        public void InjectCommandTest()
        {
            ...
            // Проверка что InjectCommand вызывает Execute у переданной команды
            mockCommand.Setup(c => c.Execute()).Verifiable();
            injectCommand.Inject(mockCommand.Object);
